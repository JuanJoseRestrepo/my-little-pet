...
*@param el servicio
*@param el costo del servicio
*@param la fecha en la que se hizo
*@param el pet que tiene el servicio
*@param la identificacion del animalito
*/
...
*@return la identificacion de la mascota
*/
...
*@param la identificacion de la mascota
*/
...
*@param el arraylist de mascotas
*/
